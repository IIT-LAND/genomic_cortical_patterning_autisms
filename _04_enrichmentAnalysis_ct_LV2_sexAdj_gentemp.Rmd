...
ggsave(filename = file.path(plotdir, "GCLUST_CT_sexAdj_LV2_MEcorr.pdf"), width=5,height=5)
p
#------------------------------------------------------------------------------


#------------------------------------------------------------------------------
ct_allVert_data = read.csv(file.path(plspath,"results","plsres_all_ct_allVertices_sexMeanCTAdj_MEcorr_bootCI4plotting_LV2_ci95.csv"))
...
ggsave(filename = file.path(plotdir, "AllVertices_CT_sexMeanCTAdj_LV2_MEcorr.pdf"), width=5,height=5)
p
#------------------------------------------------------------------------------
...
ggsave(filename = file.path(plotdir, "GCLUST_AllVertices_CT_LV2_MEcorr_comp.pdf"), width=3,height=5)
r_mat
p
#------------------------------------------------------------------------------
...
for (i in 1:length(geneclasses)){
  ...
  # }
  # 
  # if (is.element(geneclassnames[i],c("SFARI ASD","ASD DE Upreg","ASD Prenatal1","FMRP Targets1",
  #                                    "FMRP Targets2","CHD8 Targets1",
  #                                    "Ventricular Radial Glia","Intermediate Progenitors",
...
write.csv(enrich_res_table, file = here("results","enrich_res_table_CTLV2.csv"))
```
...
CT LV2 non-zero & Prenatal Excitatory & Prenatal PC2 (D-V) & ASD Prenatal CoExpMod
...
ex_pc2_asdprenatal_ctlv2_list = ex_pc2_asdprenatal_list[is.element(ex_pc2_asdprenatal_list,nz_genes)]
sort(ex_pc2_asdprenatal_ctlv2_list)

# overlap with SFARI ASD genes
ex_pc2_asdprenatal_SFARI_ctlv2_list = ex_pc2_asdprenatal_ctlv2_list[is.element(ex_pc2_asdprenatal_ctlv2_list,SFARIASD)]
sort(ex_pc2_asdprenatal_SFARI_ctlv2_list)
```
