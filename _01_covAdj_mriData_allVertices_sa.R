...
# load in MRI data
print("Loading data")
mri_data = read.csv(file.path(rootpath,"data","tidy","AllGroups_all_cortical_sa_allVertices.csv"))
...
write.csv(mri_data_adj, file = file.path(rootpath,"data","tidy","mri_data_adj_sexMeanSA_all_cortical_sa_allVertices.csv"))
